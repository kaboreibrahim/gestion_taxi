...
from taxi.views.Notebook import NotebookCreateView, load_chauffeurs,NotebookList,vehicule_list,vehicule_detail,change_statut_to_circulation,NotebookUpdateView
from taxi.views.vidange import VidangeList,VidangeCreateView,VidangeUpdateView
...
from taxi.views import afficher_informations_proprietaire,VehiculeList,VehiculeCreateView,\
    VehiculeUpdateView,afficher_details_vehicule,afficher_details_Vidange
    
from taxi.views.liaison import LiaisonVehiculeChauffeurListView,LiaisonVehiculeChauffeurUpdateView\
    ,LiaisonVehiculeChauffeurCreateView
    
from taxi.views.recette import RecetteDetails, RecetteList,RecetteUpdateView,RecetteCreateView

from taxi.views.depense import DepenseList,DepenseUpdateView,DepenseCreateView,DepenseDetails

from taxi.views.chauffeur import ChauffeurList,ChauffeurUpdateView,ChauffeurCreateView\
    ,afficher_details_Chauffeur
    
from taxi.views.CarteStationnement import CarteStationnementList,CarteStationnementUpdateView,\
    CarteStationnementCreateView,afficher_details_CarteStationnement
    
from taxi.views.Assurance import AssuranceList,AssuranceUpdateView,AssuranceCreateView,\
    AssuranceRappelView,afficher_details_Assurance,AssurancePdfView,send_email_reminders
    
from taxi.views.Patente import PatenteList,PatenteCreateView,PatenteUpdateView,afficher_details_Patente

from taxi.views.VisiteTechnique import VisiteTechniquePdfView,send_email_reminders_VT,\
...
from taxi.views.Piece import PieceCreateView,PieceListView,afficher_details_Piece,PieceUpdateView

from taxi.views.TypeDeVoiture import TypeDeVoitureCreateView,TypeDeVoitureListView,TypeDeVoitureUpdateView,afficher_details_TypeDeVoiture

from taxi.views.ModeleDeVoiture import ModeleDeVoitureCreateView,ModeleDeVoitureListView,ModeleDeVoitureUpdateView,afficher_details_ModeleDeVoiture

from taxi.views.EntreeStock import EntreeStockCreateView,EntreeStockListView,EntreeStockUpdateView,afficher_details_EntreeStock,get_stock_entre,StockPdfView

from taxi.views.SortieStock import SortieStockCreateView,SortieStockListView,SortieStockUpdateView,afficher_details_SortieStock

from taxi.views.auth import user_login,register,verify ,deconnection
from django.contrib.auth.views import PasswordResetView, PasswordResetDoneView,PasswordResetConfirmView, PasswordResetCompleteView

from taxi_api.views.piece_serializer import PieceListAPIView, PieceCreateAPIView, PieceUpdateAPIView, PieceDetailAPIView
urlpatterns = [
    ...
    path('api/', include('taxi_api_client.urls')),
